...
- [CryptoHunter APIs](https://f405946cc5f3bffc-70-29-104-37.serveousercontent.com) - Live crypto data + DeFi safety tools for AI agents. 8 x402-paid endpoints on Base mainnet: real-time prices ($0.001 USDC), gas fees ($0.001), best DEX swap quotes via CoW Protocol ($0.003), token honeypot/rug analysis via GoPlus Security ($0.003), multi-token portfolio ($0.003), No API — AI that always answers No ($0.01), Rickroll API ($0.01). No API keys needed. USDC on Base mainnet. [`/.well-known/x402.json`](https://f405946cc5f3bffc-70-29-104-37.serveousercontent.com/.well-known/x402.json) | [Manifest](https://f405946cc5f3bffc-70-29-104-37.serveousercontent.com/crypto/manifest)
