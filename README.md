...
- [anchor-x402](https://anchor-x402.com) - Nine commodity services for AI agents: dual-chain hash anchoring (Base + Solana mainnet in one call), OFAC sanctions screening, signed decision attestation with on-chain receipt, mainnet tx decode, ENS / Bonfida SNS resolver, USD spot price, EVM calldata decode, freeform datetime parsing, and bundled wallet intelligence (8 sources in one call). $0.001–$0.010 USDC per call on Base or Solana. v2 PaymentRequired with `extensions.bazaar`; CDP facilitator. No API keys, no signup. ([Trust portal](https://anchor-x402.com/trust/)) ([API](https://api.anchor-x402.com)) ([OpenAPI](https://api.anchor-x402.com/openapi.json)) ([Status](https://anchor-x402.betteruptime.com)) ([npm MCP](https://www.npmjs.com/package/anchor-x402-mcp)) ([GitHub](https://github.com/hypeprinter007-stack/anchor-x402))
