...
- - **[DeFi Yield Decision Engine](https://defi-yield-engine-production.up.railway.app/mcp)** — Complete DeFi Intelligence Engine covering Yield, Liquid Staking, Restaking/LRT, Real World Assets, and Perpetuals across 7,000+ protocols and 500+ chains. Risk-adjusted single recommendations with reasoning — 97% fewer tokens than raw DeFiLlama. 9 paid tools + 10 free tools including APY alerts, market overview, and A2A Agent Card. 0.05 USDC/call on Base · MCP streamable-http · x402 native
